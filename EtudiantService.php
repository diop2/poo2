...
{  
    ...
    private $pass;
    private $dbname;
    public function __construct($serv = "localhost",$login ="root",$pass = "101419", $dbname="ouz"){
    $this->isconnect= true;
    $this->serv=$serv;
    $this->login=$login;
    $this->pass=$pass;
    ...
    public function add(etudiant $etudiant)
    {
        ...
        try{
            ...
            if(get_class($etudiant)=='nonboursier'){
                ...
                $ajouter=$this->pdo->prepare("INSERT INTO non_boursier(id_etudiant, adresse) VALUES(:id_etudiant,:adresse)");
